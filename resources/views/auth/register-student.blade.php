<x-guest-layout>
    ...
    ================================================================
    Pastikan aset visual (CSS, banner, maskot, muzik) dimuatkan
    dalam fail layout utama (`resources/views/layouts/guest.blade.php`) 
    untuk dipaparkan di sini.
    ================================================================
    --}}

    <div class="login-card-glass"> <h2 class="text-center text-2xl font-bold text-white mb-4">Sign Up for Student</h2>
